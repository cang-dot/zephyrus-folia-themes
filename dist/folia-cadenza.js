...
const ne = { class: "folia-cadenza-root w-full h-full overflow-hidden pointer-events-none select-none" }, oe = { class: "absolute inset-0 w-full h-full" }, se = {
  ...
  setup(q) {
    const T = q, l = X(T, T.settings), P = a(() => l.nowTime.value), N = a(() => l.nowIndex.value), _ = a(() => l.lrcArray.value), O = a(() => _.value.map((e) => e.startTime ?? 0)), W = a(() => l.getCoverColor()), $ = a(() => W.value.primary || "#ffffff"), f = a(() => l.getClimaxState().isInClimax ? "#ff6b6b" : $.value), M = a(() => te(_.value, O.value)), E = a(() => {
      const e = N.value;
