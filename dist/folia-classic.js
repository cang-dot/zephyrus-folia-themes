(function(){var s=document.createElement('style');s.textContent=".folia-cadenza-root[data-v-f294dd11],.folia-classic-root[data-v-96ae650c]{background:transparent} .folia-ripple[data-v-96ae650c]{animation:folia-ripple-kf-96ae650c .5s ease-out forwards} @keyframes folia-ripple-kf-96ae650c{0%{transform:translate(-50%,-50%) scale(.2);opacity:.8}to{transform:translate(-50%,-50%) scale(1.5);opacity:0}} @keyframes folia-float-96ae650c{0%,to{transform:translateY(0)}50%{transform:translateY(-14px)}} .folia-fade-enter-active[data-v-96ae650c],.folia-fade-leave-active[data-v-96ae650c]{transition:all .3s ease} .folia-fade-enter-from[data-v-96ae650c]{opacity:0;filter:blur(10px);transform:scale(.9)} .folia-fade-leave-to[data-v-96ae650c]{opacity:0;filter:blur(20px);transform:scale(1.1)}";document.head.appendChild(s)})();/**
* @vue/shared v3.5.39
