(function(){var s=document.createElement('style');s.textContent=".folia-cadenza-root[data-v-f294dd11],.folia-classic-root[data-v-96ae650c]{background:transparent} .folia-ripple[data-v-96ae650c]{animation:folia-ripple-kf-96ae650c .5s ease-out forwards} @keyframes folia-ripple-kf-96ae650c{0%{transform:translate(-50%,-50%) scale(.2);opacity:.8}to{transform:translate(-50%,-50%) scale(1.5);opacity:0}} @keyframes folia-float-96ae650c{0%,to{transform:translateY(0)}50%{transform:translateY(-14px)}} .folia-fade-enter-active[data-v-96ae650c],.folia-fade-leave-active[data-v-96ae650c]{transition:all .3s ease} .folia-fade-enter-from[data-v-96ae650c]{opacity:0;filter:blur(10px);transform:scale(.9)} .folia-fade-leave-to[data-v-96ae650c]{opacity:0;filter:blur(20px);transform:scale(1.1)}";document.head.appendChild(s)})();var X=function(m,k){var e=m.__esModule||m[Symbol.toStringTag]==='Module'?function(){return m.default}:function(){return m};var d=e();for(var p in m){if(p!=='default'&&!Object.prototype.hasOwnProperty.call(d,p)){Object.defineProperty(d,p,{enumerable:true,get:(function(x){return m[x]}).bind(null,p)})}}if(k){for(var i=0;i<k.length;i++){d[k[i][0]]=k[i][1];}}return d;};
var __sh_runtime_dom_esm_bundler_CwR6cVdo_js={};
(function(){'use strict';
...
const de = { class: "folia-classic-root w-full h-full flex items-center justify-center overflow-hidden pointer-events-none select-none" }, pe = {
  ...
  setup(F) {
    const S = F, i = Y(S, S.settings), $ = o(() => i.nowTime.value), L = o(() => i.nowIndex.value), C = o(() => i.lrcArray.value), A = o(() => {
      const e = [];
      for (const a of C.value)
        e.push(a.startTime ?? 0);
      return e;
    }), R = o(() => i.getCoverColor()), p = o(() => R.value.primary || "#ffffff"), m = o(() => i.getClimaxState().isInClimax ? "#ff6b6b" : p.value), T = o(() => fe(p.value, 0.5)), _ = o(() => re(C.value, A.value)), r = o(() => {
      const e = L.value;
      return e < 0 || e >= _.value.length ? null : _.value[e];
    }), v = o(() => {
      const e = r.value;
      if (!e || e.fullText === "......") return e?.words || [];
      const a = ue(e, { semantic: !0, sticky: !0 });
      return ce(a);
    }), w = b({});
    Z($, (e) => {
      const a = r.value;
      ...
      const n = a.renderHints ?? ie(a.startTime, a.endTime), t = n.wordRevealMode === "instant" ? 0.03 : n.wordRevealMode === "fast" ? 0.08 : 0.15, l = {};
...
}, me = /* @__PURE__ */ X(pe, [["__scopeId", "data-v-96ae650c"]]);
me.settings = [
