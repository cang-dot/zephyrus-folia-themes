...
const G = { class: "folia-partita-root w-full h-full flex items-center justify-center overflow-hidden pointer-events-none select-none" }, J = { class: "relative z-10 w-full max-w-6xl h-[70vh] flex gap-4 items-center justify-center p-8" }, Q = {
  ...
  setup(_) {
    const m = _, u = P(m, m.settings), S = t(() => u.nowTime.value), L = t(() => u.nowIndex.value), v = t(() => u.lrcArray.value), j = t(() => v.value.map((e) => e.startTime ?? 0)), z = t(() => u.getCoverColor()), f = t(() => z.value.primary || "#ffffff"), p = t(() => K(f.value, 0.5)), y = t(() => u.getClimaxState().isInClimax ? "#ff6b6b" : f.value), h = t(() => H(v.value, j.value)), n = t(() => {
      const e = L.value;
      return e < 0 || e >= h.value.length ? null : h.value[e];
    }), F = t(() => n.value?.startTime ?? 0), x = t(() => {
      const e = n.value;
      if (!e) return [];
      const r = U(e, { semantic: !0, sticky: !0 });
      return $(r);
    }), g = t(() => {
      const e = x.value;
    ...
    V(S, (e) => {
      if (!n.value) return;
      const r = n.value.renderHints ?? O(n.value.startTime, n.value.endTime), a = r.wordRevealMode === "instant" ? 0.03 : r.wordRevealMode === "fast" ? 0.08 : 0.15, s = {};
      x.value.forEach((o, c) => {
    ...
    return (e, r) => (l(), i("div", G, [
      ...
      }, T(n.value.translation), 5)) : R("", !0)
    ]));
  }
}, X = /* @__PURE__ */ N(Q, [["__scopeId", "data-v-bde952ec"]]);
X.settings = [
