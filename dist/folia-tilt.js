(function(){var s=document.createElement('style');s.textContent=".folia-tilt-root[data-v-492aa817]{background:transparent} .folia-fade-enter-active[data-v-492aa817],.folia-fade-leave-active[data-v-492aa817]{transition:all .35s ease} .folia-fade-enter-from[data-v-492aa817]{opacity:0;transform:scale(.95)} .folia-fade-leave-to[data-v-492aa817]{opacity:0;transform:scale(1.05)}";document.head.appendChild(s)})();var Y=function(m,k){var e=m.__esModule||m[Symbol.toStringTag]==='Module'?function(){return m.default}:function(){return m};var d=e();for(var p in m){if(p!=='default'&&!Object.prototype.hasOwnProperty.call(d,p)){Object.defineProperty(d,p,{enumerable:true,get:(function(x){return m[x]}).bind(null,p)})}}if(k){for(var i=0;i<k.length;i++){d[k[i][0]]=k[i][1];}}return d;};
...
const Z = { class: "folia-tilt-root w-full h-full flex items-center justify-center overflow-hidden pointer-events-none select-none" }, ee = { class: "relative z-10 w-full h-[70vh] flex flex-col items-center justify-center p-8 gap-4" }, te = {
  ...
  setup(B) {
    const g = B, c = $(g, g.settings), k = l(() => c.nowTime.value), M = l(() => c.nowIndex.value), C = l(() => c.lrcArray.value), z = l(() => C.value.map((e) => e.startTime ?? 0)), A = l(() => c.getCoverColor()), m = l(() => A.value.primary || "#ffffff"), w = l(() => X(m.value, 0.5)), S = l(() => U(C.value, z.value)), f = l(() => {
      const e = M.value;
    ...
    return R(() => {
        ...
        G(W, {
          ...
          default: H(() => [
            E.value && p.value.length > 0 ? (r(), i("div", {
              ...
              (r(!0), i(b, null, F(p.value, (t, o) => (r(), i("div", {
                key: o,
                class: J(["flex flex-wrap justify-center gap-[0.15em]", t.isTilt ? "italic font-light" : "font-normal"]),
                style: v({
                ...
                (r(!0), i(b, null, F(t.chars, (n, s) => (r(), i("span", {
                  key: s,
      ...
      }, _(f.value.translation), 5)) : Q("", !0)
    ]));
  }
}, ae = /* @__PURE__ */ Y(te, [["__scopeId", "data-v-492aa817"]]);
ae.settings = [
