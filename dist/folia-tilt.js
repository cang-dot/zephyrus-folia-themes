(function(){var s=document.createElement('style');s.textContent=".folia-tilt-root[data-v-492aa817]{background:transparent} .folia-fade-enter-active[data-v-492aa817],.folia-fade-leave-active[data-v-492aa817]{transition:all .35s ease} .folia-fade-enter-from[data-v-492aa817]{opacity:0;transform:scale(.95)} .folia-fade-leave-to[data-v-492aa817]{opacity:0;transform:scale(1.05)}";document.head.appendChild(s)})();/**
* @vue/shared v3.5.39
